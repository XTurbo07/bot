...
[![NPM version](https://img.shields.io/npm/v/sdk-builder.svg)](https://npmjs.org/package/sdk-builder) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/sdk-builder)
...
```ts
import fs from 'fs';
import Petstore, { toFile } from 'sdk-builder';
...
```ts
import Petstore from 'npm:sdk-builder';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/sdk-builder-typescript/issues) with questions, bugs, or suggestions.
